...
//uint16_t gpio_pin[NUMBER_OF_BUTTONS] = {BUTTON_0_Pin, BUTTON_1_Pin, BUTTON_2_Pin};
//GPIO_TypeDef* gpio_port[NUMBER_OF_BUTTONS] = {BUTTON_0_GPIO_Port, BUTTON_1_GPIO_Port, BUTTON_2_GPIO_Port};
//
